...
const MetaTrader5forAndroid = () => {
  ...
  const comparisonData = [
    ...
    { feature: "Copy Trading & Signals", mt5: "Enabled", others: "Enabled" },
    {
    ...
    <Container sx={{ backgroundColor: "#fff" }} maxWidth={false} disableGutters>
      ...
      <Box
        sx={{
          ...
          color: "white",
          backgroundImage: `url('Images/MetaTrader5Android/hedgestandardaccimage.jpg')`, // 👈 replace with your image path
      ...
      <Grid
        ...
        sx={{
          position: "relative",
          height: "300px",
          backgroundImage: 'url("/Images/MainContentImages/New CTA (1).webp")',
          backgroundSize: "cover",
          backgroundPosition: "center",
